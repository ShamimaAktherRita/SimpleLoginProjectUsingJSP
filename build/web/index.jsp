...
<html lang="en">
    <head>
        ...
        <title>Akili ni mali- Knowledge is wealth</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav
            ...
            id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Shamima Akther Rita</a>
                <button
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="assets/img/prof.jpg"
                     style="border-radius: 50%; height:250px;" alt="..." />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Welcome To Rita's World!!!</h1>
                <!-- Icon Divider-->
                ...
                <p class="masthead-subheading font-weight-light mb-0">Java
                    Development - Web Development - Dynamic Projects</p>
                <br><p> <h6>Karibu nyumbani-Welcome Home</h6></p>
            </div>
        </header>
        <!-- Portfolio Section-->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto">
                        <p class="lead">I am a Computer Science Engineering Student.I have interest to build up something new which will be exciting &
                            creative respectively.</p>
                    </div>
                    <div class="col-lg-4 me-auto">
                        <p class="lead">Everyone can fulfill their wish in their life if they have proper respect to their work & required dedication toward their duty. </p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <p class="lead mb-0">
                            Zakir Hossain Road, Block-E <br /> Mohammadpur, Dhaka-1207
                        </p>
                    </div>
                    <!-- Footer Social Icons-->
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <h4 class="text-uppercase mb-4">Around the Web</h4>
                        <a class="btn btn-outline-light btn-social mx-1" href="https://www.facebook.com/rita.shamima596"><i
                                class="fab fa-fw fa-facebook-f"></i></a> <a
                            class="btn btn-outline-light btn-social mx-1" href="https://twitter.com/home"><i
                                class="fab fa-fw fa-twitter"></i></a> <a
                            class="btn btn-outline-light btn-social mx-1" href="https://www.linkedin.com/in/shamima-akther-7b7a70211/"><i
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="lead mb-0">
                            Always ready to help you if possible!!
                            <a href="https://www.facebook.com/rita.shamima596">Do Contact</a> .
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container">
                <small>Copyright &Shamima Akther Rita</small>
            </div>
        </div>
        <!-- Portfolio Modals-->
        <!-- Portfolio Modal 1-->
